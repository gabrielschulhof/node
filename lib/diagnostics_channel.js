...
class ActiveChannel {
  ...
  get hasSubscribers() {
    if (this.name.match(/express/))
      console.log(`${this.name} does have subscribers`)
    return true;
  }

  publish(data) {
    if (this.name.match(/express/))
      console.log(`${this.name} publish is actual`)
...
class Channel {
  ...
  get hasSubscribers() {
    if (this.name.match(/express/))
      console.log(`${this.name} has no subscribers`)
    return false;
  }

  publish() {
    if (this.name.match(/express/))
      console.log(`${this.name} publish is noop`)
  }
