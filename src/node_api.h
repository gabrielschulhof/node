...
NAPI_EXTERN napi_status NAPI_CDECL napi_queue_async_work(node_api_pure_env env,
                                                         napi_async_work work);
NAPI_EXTERN napi_status NAPI_CDECL napi_cancel_async_work(node_api_pure_env env,
                                                          napi_async_work work);

// version management
NAPI_EXTERN napi_status NAPI_CDECL
napi_get_node_version(node_api_pure_env env, const napi_node_version** version);

#if NAPI_VERSION >= 2

// Return the current libuv event loop for a given environment
NAPI_EXTERN napi_status NAPI_CDECL
napi_get_uv_event_loop(node_api_pure_env env, struct uv_loop_s** loop);
...
NAPI_EXTERN napi_status NAPI_CDECL napi_add_env_cleanup_hook(
    node_api_pure_env env, napi_cleanup_hook fun, void* arg);
...
NAPI_EXTERN napi_status NAPI_CDECL
napi_close_callback_scope(node_api_pure_env env, napi_callback_scope scope);
...
napi_create_threadsafe_function(napi_env env,
                                ...
                                node_api_pure_finalize thread_finalize_cb,
                                void* context,
...
NAPI_EXTERN napi_status NAPI_CDECL
node_api_get_module_file_name(node_api_pure_env env, const char** result);
