...
// The pure version of GET_AND_THROW_LAST_ERROR. We cannot access any
...
#define NODE_API_PURE_ASSERT_BASE(assertion, message, ret_val)                 \
  do {                                                                         \
    if (!(assertion)) {                                                        \
...
#define NODE_API_PURE_ASSERT_RETURN_VOID(assertion, message)                   \
  NODE_API_PURE_ASSERT_BASE(assertion, message, NODE_API_RETVAL_NOTHING)
...
#define NODE_API_PURE_CALL_BASE(env, the_call, ret_val)                        \
  do {                                                                         \
    if ((the_call) != napi_ok) {                                               \
...
#define NODE_API_PURE_CALL_RETURN_VOID(env, the_call)                          \
  NODE_API_PURE_CALL_BASE(env, the_call, NODE_API_RETVAL_NOTHING)
